...
TEMPLATES = {
    ...
    "deck_capacity_plan.json": "{\n  \"target_pages\": null,\n  \"recommended_pages\": null,\n  \"max_supported_pages\": null,\n  \"budget_tiers\": {\n    \"conservative\": {\"pages\": null, \"core_pages\": null, \"proof_pages\": null, \"extension_pages\": null, \"appendix_pages\": null, \"required_inputs\": []},\n    \"recommended\": {\"pages\": null, \"core_pages\": null, \"proof_pages\": null, \"extension_pages\": null, \"appendix_pages\": null, \"required_inputs\": []},\n    \"extended\": {\"pages\": null, \"core_pages\": null, \"proof_pages\": null, \"extension_pages\": null, \"appendix_pages\": null, \"required_inputs\": []},\n    \"appendix_heavy\": {\"pages\": null, \"core_pages\": null, \"proof_pages\": null, \"extension_pages\": null, \"appendix_pages\": null, \"required_inputs\": []}\n  },\n  \"notes\": \"\"\n}\n",
    "deck_gap_registry.json": "{\n  \"gaps\": []\n}\n",
    "deck_question_queue.md": "# Question Queue\n\n（由 expert-interview 生成；进入逐页稿前先补齐 blocking gap）\n",
    "deck_section_packages.md": "# Section Packages\n\n## Section 1\n\n- section_id:\n- objective:\n- page_count:\n- page_ids:\n- claim_ids:\n- allowed_evidence:\n- allowed_topics:\n- forbidden_topics:\n- input_transition:\n- output_transition:\n- density_level:\n- suggested_archetypes:\n- dense_archetype:\n\n（待拆包）\n",
